...
const PHONE = ""; // Left blank since no phone is currently listed. Add number here to re-enable "Call Us" buttons.
    ...
    >
      <div className="container flex items-center justify-between h-16 md:h-20">
        <Link to="/" className="font-display text-2xl font-bold">
          <span className={showSolid ? "text-primary" : "text-primary-foreground"}>Bubbs</span>
          <span className={showSolid ? "text-foreground" : "text-primary-foreground/80"}> Cafe</span>
        </Link>
